"""
Double Deep Q-learning Neural Network (Double DQN) based on Open AI gym - Atari game : Assault_v4
Author : Johnny Yu
...
# TODO: if time available, add Tensorboard: check performance
...
if __name__ == '__main__':
    ...
    for i_episode in range(n_episodes):
        ...
        # If enough memory stored, agent learns from prev exp (Monte-Carlo), and store as meta data
        ct = time.time()
